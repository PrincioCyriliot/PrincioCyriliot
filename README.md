...
![C](https://img.shields.io/badge/C-A8B9CC?style=for-the-badge&logo=c%2B%2B&logoColor=red)
...
| :--- | :--- | :--- |
| 🏡 **[Smart Home Domotique](https://github.com/PrincioCyriliot/Smart_home_domotique)** | Système domotique intégrant ESP8266, capteurs PIR et contrôle de moteurs. | `C++` `ESP8266` `IoT` |
| 🌐 **[Site Vitrine Responsive](https://github.com/PrincioCyriliot/Site-vitrine)** | Site web responsive déployé et hébergé en ligne sur Render. | `HTML` `CSS` `JS` |
| 📋 **[Gestionnaire de Tâches](https://github.com/PrincioCyriliot/systeme-de-gestion-taches-dom)** | Application web intuitive de gestion de tâches via manipulation du DOM. | `JavaScript` `DOM` |
| 📚 **[Gestion de Bibliothèque](https://github.com/PrincioCyriliot/examen2)** | Système complet de gestion de livres avec authentification et BDD. | `PHP` `MySQL` `PDO` |
